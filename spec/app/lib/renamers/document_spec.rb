  ...
  describe '.rename_file' do
    context 'title' do
      ...
      context 'with spaces' do
        it 'renames' do
          file_name = 'Document-111 W Street - Lead Based Paint Thu Mar 19 2009'
    ...
    context 'with scanner name' do
      it 'renames' do
        file_name = 'Document-111 W Street - return of gifts Fri Apr 27 2012 ScanSnap Manager S1500M'
